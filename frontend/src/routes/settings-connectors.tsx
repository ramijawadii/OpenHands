...
const LS_PERMS = "cg_connector_perms";
...
function AzureIcon({ size = 20, uid = "a" }: { size?: number; uid?: string }) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M5.335 1.375C5.447 1.042 5.759.818 6.11.818H11.25L5.915 16.626c-.112.332-.424.556-.775.556H1.14c-.56 0-.954-.55-.775-1.08L5.335 1.375z"
        fill={`url(#${g(0)})`}
      />
      <path
        d="M13.552 11.455H5.451c-.34 0-.506.417-.254.649l5.205 4.858c.152.142.351.22.558.22h4.587l-1.995-5.727z"
        fill="#0078D4"
      />
      <path
        d="M6.11.818c-.35 0-.663.224-.775.557L.364 16.102c-.179.53.215 1.08.775 1.08H5.14c.35 0 .663-.224.775-.556L6.903 13.7l3.498 3.264c.15.141.35.22.558.22h4.586l-1.993-5.728H7.66L11.25.818H6.11z"
        fill={`url(#${g(1)})`}
      />
      <path
        d="M12.665 1.375c-.112-.333-.424-.557-.775-.557H6.136h.027c.35 0 .663.224.775.557l4.97 14.727c.18.531-.214 1.08-.775 1.08h-.087H16.86c.56 0 .954-.55.775-1.08L12.665 1.375z"
        fill={`url(#${g(2)})`}
      />
    </svg>
  );
...
function GcpIcon({ size = 20 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M40.728 20.488l2.05.035 5.57-5.57.27-2.36C44.2 8.657 38.367 6.26 31.993 6.26c-11.54 0-21.28 7.852-24.163 18.488.608-.424 1.908-.106 1.908-.106l11.13-1.83s.572-.947.862-.9A13.88 13.88 0 0132 17.375c3.3.007 6.34 1.173 8.728 3.102z"
        fill="#ea4335"
      />
      <path
        d="M56.17 24.77c-1.293-4.77-3.958-8.982-7.555-12.177l-7.887 7.887c3.16 2.55 5.187 6.452 5.187 10.82v1.392c3.837 0 6.954 3.124 6.954 6.954 0 3.837-3.124 6.954-6.954 6.954H32.007L30.615 48v8.346l1.392 1.385h13.908A18.11 18.11 0 0064 39.647c-.007-6.155-3.1-11.6-7.83-14.876z"
        fill="#4285f4"
      />
      <path
        d="M18.085 57.74h13.9V46.6h-13.9a6.89 6.89 0 01-2.862-.622l-2.007.615-5.57 5.57-.488 1.88a18 18 0 0010.926 3.689z"
        fill="#34a853"
      />
      <path
        d="M18.085 21.57A18.11 18.11 0 000 39.654c0 5.873 2.813 11.095 7.166 14.403l8.064-8.064a6.96 6.96 0 01-4.099-6.339c0-3.837 3.124-6.954 6.954-6.954 2.82 0 5.244 1.7 6.34 4.1l8.064-8.064c-3.307-4.353-8.53-7.166-14.403-7.166z"
        fill="#fbbc05"
      />
    </svg>
  );
...
interface Op {
  ...
  opType: OpType;
  risk: Risk;
  defaultState: PermState;
}
interface CnappLayer {
  num: number;
  title: string;
  subtitle: string;
  ops: Op[];
...
const AWS_LAYERS: CnappLayer[] = [
  {
    num: 1,
    title: "Identity & Access (CIEM)",
    subtitle:
      "IAM users, roles, groups, MFA, access keys, SCPs, federated identity, privilege escalation",
    ops: mkOps(1, [
      ...
      [
        "Access Analyzer — list analyzers",
      ...
      [
        "Access Analyzer — get finding",
        "access-analyzer:GetFinding",
        "READ",
        "LOW",
      ],
      [
        "Access Analyzer — list access previews",
        "access-analyzer:ListAccessPreviews",
        "READ",
        "LOW",
      ],
      [
        "SSO — list account assignments",
  ...
  },
  {
    ...
    subtitle:
      "Service accounts, API tokens, workload identities, AI agent credentials, IRSA, OIDC",
    ops: mkOps(2, [
      ...
      [
        "List SSM parameters (names only)",
      ...
      [
        "List Bedrock model invocation access",
  ...
  {
    num: 3,
    title: "Posture & Config (CSPM)",
    subtitle:
      "Misconfiguration, drift detection, asset inventory, secure score, Config rules, Security Hub",
    ops: mkOps(3, [
      ...
      [
        "Get Security Hub standards controls",
      ...
      [
        "Get Trusted Advisor check result",
      ...
      [
        "Describe ElasticSearch/OpenSearch",
  ...
  },
  {
    ...
    subtitle:
      "CIS, NIST, PCI-DSS, HIPAA, SOC2, ISO 27001 — Audit Manager, Conformance Packs, Artifact",
    ops: mkOps(4, [
      [
      ...
      [
        "Get Audit Manager assessment",
        "auditmanager:GetAssessment",
        "READ",
        "LOW",
      ],
      [
        "List Audit Manager frameworks",
        "auditmanager:ListAssessmentFrameworks",
        "READ",
        "LOW",
      ],
      [
        "List Audit Manager controls",
        "auditmanager:ListControls",
        "READ",
        "LOW",
      ],
      [
        "Get Audit Manager evidence",
        "auditmanager:GetEvidenceFolder",
        "READ",
        "LOW",
      ],
      [
        "List Security Hub standards",
        "securityhub:DescribeStandards",
        "READ",
        "LOW",
      ],
      [
        "Get Config compliance timeline",
      ...
      [
        "Describe Config aggregators",
        "config:DescribeConfigurationAggregators",
        "READ",
        "LOW",
      ],
      [
        "List AWS Artifact agreements",
        "aws-artifact:ListAgreements",
        "READ",
        "LOW",
      ],
      [
  ...
  },
  {
    ...
    subtitle:
      "VMs, serverless, vulnerability scanning, runtime defense, malware, patch compliance",
    ops: mkOps(5, [
      ...
      [
        "List Inspector delegated admins",
      ...
      [
        "Archive Inspector finding",
        "inspector2:BatchUpdateFindings",
        "WRITE",
        "MEDIUM",
      ],
      [
  ...
  {
    num: 6,
    title: "Containers & Kubernetes (KSPM)",
    subtitle:
      "EKS cluster posture, ECR image scanning, ECS task definitions, registry security",
    ops: mkOps(6, [
      ["List EKS clusters", "eks:ListClusters", "READ", "LOW"],
  ...
  },
  {
    ...
    subtitle:
      "VPC, security groups, NACLs, WAF, Shield, Network Firewall, flow logs, Route53",
    ops: mkOps(7, [
      ["Describe VPCs", "ec2:DescribeVpcs", "READ", "LOW"],
      ["Describe subnets", "ec2:DescribeSubnets", "READ", "LOW"],
      ["Describe security groups", "ec2:DescribeSecurityGroups", "READ", "LOW"],
      ...
      [
        "Describe ELB listeners",
        "elasticloadbalancing:DescribeListeners",
        "READ",
        "LOW",
      ],
      [
        "Describe ELB target groups",
      ...
      [
        "Create/modify security group rule",
  ...
  {
    num: 8,
    title: "Threat Detection (CDR)",
    subtitle:
      "GuardDuty, Detective, CloudWatch alerts, log analytics, threat intelligence",
    ops: mkOps(8, [
      ...
      [
        "List GuardDuty threat intel sets",
        "guardduty:ListThreatIntelSets",
        "READ",
        "LOW",
      ],
      [
        "Get GuardDuty threat intel set",
      ...
      [
        "Create GuardDuty threat intel set",
  ...
  },
  {
    ...
    title: "IaC & DevSecOps",
    subtitle:
      "CloudFormation, CodePipeline, CodeBuild, CodeArtifact — template scanning, CI/CD gates",
    ops: mkOps(9, [
      [
      ...
      [
        "List CloudFormation change sets",
        "cloudformation:ListChangeSets",
        "READ",
        "LOW",
      ],
      [
        "Describe CloudFormation change set",
      ...
      [
        "Get CodePipeline pipeline state",
  ...
  },
  {
    ...
    subtitle:
      "ECR image scanning, CodeArtifact packages, AWS Signer — SBOM generation, SLSA provenance",
    ops: mkOps(10, [
      ["List ECR repositories", "ecr:DescribeRepositories", "READ", "LOW"],
      [
        "Describe ECR images (digests, tags)",
        "ecr:DescribeImages",
        "READ",
        "LOW",
      ],
      [
        "Get ECR image scan findings (SCA)",
        "ecr:DescribeImageScanFindings",
        "READ",
        "LOW",
      ],
      ...
      [
        "Get CodeArtifact package version",
        "codeartifact:DescribePackageVersion",
        "READ",
        "LOW",
      ],
      [
        "List CodeArtifact package version assets",
        "codeartifact:ListPackageVersionAssets",
        "READ",
        "LOW",
      ],
      [
        "Get CodeArtifact domain policy",
        "codeartifact:GetDomainPermissionsPolicy",
        "READ",
        "LOW",
      ],
      [
        "Inspector SBOM export findings",
        "inspector2:ListFindings",
        "READ",
        "LOW",
      ],
      [
        "Get AWS Signer signing profiles",
      ...
      ["Start ECR image scan", "ecr:StartImageScan", "WRITE", "LOW"],
      [
        "Put CodeArtifact package origin config",
  ...
  },
  {
    ...
    subtitle:
      "Secrets Manager, Macie sensitive data, SSM parameters, CodeGuru, KMS key metadata",
    ops: mkOps(11, [
      [
        "List Secrets Manager secrets",
        "secretsmanager:ListSecrets",
      ...
      [
        "List Macie findings (sensitive data)",
        "macie2:ListFindings",
        "READ",
        "LOW",
      ],
      [
        "Describe Macie classification jobs",
      ...
      [
        "List GuardDuty findings (credential exfil)",
      ...
      [
        "Put Secrets Manager secret value",
        "secretsmanager:PutSecretValue",
        "WRITE",
        "HIGH",
      ],
  ...
  },
  {
    ...
    title: "API Security",
    subtitle:
      "API Gateway inventory, WAF associations, CloudFront, GuardDuty API findings, L7 listeners",
    ops: mkOps(12, [
      ["Get API Gateway REST APIs", "apigateway:GET /restapis", "READ", "LOW"],
      [
        "Get API Gateway stages",
        "apigateway:GET /restapis/{id}/stages",
        "READ",
        "LOW",
      ],
      [
        "Get API Gateway authorizers",
        "apigateway:GET /restapis/{id}/authorizers",
        "READ",
        "LOW",
      ],
      [
        "Get API Gateway usage plans",
      ...
      [
        "Get API Gateway v2 routes",
        "apigateway:GET /v2/apis/{id}/routes",
        "READ",
        "LOW",
      ],
      [
        "List WAF web ACL associations",
      ...
      [
        "Describe CloudFront origin request policies",
  ...
  },
  {
    ...
    subtitle:
      "S3, Macie, RDS, DynamoDB, Redshift, KMS, Glue — encryption, public access, sensitive data",
    ops: mkOps(13, [
      ["List S3 buckets", "s3:ListAllMyBuckets", "READ", "LOW"],
      ["Get S3 bucket ACL", "s3:GetBucketAcl", "READ", "LOW"],
      ["Get S3 bucket policy", "s3:GetBucketPolicy", "READ", "LOW"],
  ...
  },
  {
    ...
    subtitle:
      "IAM Identity Center applications, SSO assignments, GuardDuty SaaS findings",
    ops: mkOps(14, [
      [
        "List IAM Identity Center applications",
        "sso:ListApplications",
        "READ",
        "LOW",
      ],
      [
        "List IAM Identity Center account assignments",
        "sso:ListAccountAssignments",
        "READ",
        "LOW",
      ],
      ...
      [
        "List GuardDuty SaaS API findings",
        "guardduty:ListFindings",
        "READ",
        "LOW",
      ],
      [
        "List Security Hub enabled products",
        "securityhub:ListEnabledProductsForImport",
        "READ",
        "LOW",
      ],
      [
        "Assign SSO permission set",
  ...
  {
    num: 15,
    title: "AI Security Posture (AI-SPM)",
    subtitle:
      "Bedrock models/guardrails, SageMaker domains, AI BOM, training data privacy, GenAI attack surface",
    ops: mkOps(15, [
      [
      ...
      [
        "Get Bedrock invocation logging config",
      ...
      [
        "Get SageMaker model card",
        "sagemaker:DescribeModelCard",
        "READ",
        "LOW",
      ],
      [
        "Describe Macie (training data privacy)",
      ...
      [
        "Put model invocation logging config",
...
const AZURE_LAYERS: CnappLayer[] = [
  {
    ...
    title: "Identity & Access (CIEM)",
    subtitle:
      "Entra ID users, groups, roles, MFA, PIM, Conditional Access, app registrations, OAuth consents",
    ops: mkOps(1, [
      ...
      [
        "Read MFA authentication methods",
        "UserAuthenticationMethod.Read.All",
        "READ",
        "LOW",
      ],
      [
        "Read PIM eligible assignments",
      ...
      [
        "ARM: Read role assignments",
        "Microsoft.Authorization/roleAssignments/read",
        "READ",
        "LOW",
      ],
      [
        "ARM: Read role definitions",
        "Microsoft.Authorization/roleDefinitions/read",
        "READ",
        "LOW",
      ],
      [
        "ARM: Read management groups",
        "Microsoft.Management/managementGroups/read",
        "READ",
        "LOW",
      ],
      [
        "ARM: Read policy assignments",
      ...
      [
        "ARM: Create role assignments",
        "Microsoft.Authorization/roleAssignments/write",
        "WRITE",
        "HIGH",
      ],
      [
        "ARM: Delete role assignments",
        "Microsoft.Authorization/roleAssignments/delete",
        "WRITE",
        "HIGH",
      ],
      [
        "Update PIM assignments",
  ...
  },
  {
    ...
    title: "Non-Human Identity (NHI)",
    subtitle:
      "Managed identities, service principals, app credentials, Key Vault keys, Function/AKS identities",
    ops: mkOps(2, [
      [
        "Read managed identities",
        "Microsoft.ManagedIdentity/userAssignedIdentities/read",
        "READ",
        "LOW",
      ],
      [
        "Read system-assigned identities",
      ...
      [
        "Read Key Vault secrets metadata",
        "Microsoft.KeyVault/vaults/secrets/read",
        "READ",
        "LOW",
      ],
      [
        "Read Key Vault keys metadata",
      ...
      [
        "Read AKS cluster identity",
        "Microsoft.ContainerService/managedClusters/read",
        "READ",
        "LOW",
      ],
      [
        "Read Logic App connections",
        "Microsoft.Logic/workflows/read",
        "READ",
        "LOW",
      ],
      [
        "Read automation accounts",
      ...
      [
        "Create managed identity role assignment",
        "Microsoft.Authorization/roleAssignments/write",
        "WRITE",
        "HIGH",
      ],
  ...
  },
  {
    ...
    title: "Posture & Config (CSPM)",
    subtitle:
      "Defender for Cloud assessments, Secure Score, Resource Graph, Policy compliance, storage config",
    ops: mkOps(3, [
      [
      ...
      [
        ...
        "Microsoft.Security/recommendations/read",
        "READ",
        "LOW",
      ],
      [
        "Read security contacts",
      ...
      [
        "Read all resources (Resource Graph)",
        "Microsoft.ResourceGraph/resources/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure Policy assignments",
        "Microsoft.Authorization/policyAssignments/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure Policy definitions",
  ...
  },
  {
    ...
    title: "Compliance & Governance",
    subtitle:
      "Regulatory compliance assessments, Policy insights, Compliance Manager, Management Groups",
    ops: mkOps(4, [
      [
        "Read regulatory compliance assessments",
        "Microsoft.Security/regulatoryComplianceAssessments/read",
        "READ",
        "LOW",
      ],
      [
        "Read regulatory compliance controls",
        "Microsoft.Security/regulatoryComplianceControls/read",
        "READ",
        "LOW",
      ],
      [
        "Read regulatory compliance standards",
        "Microsoft.Security/regulatoryComplianceStandards/read",
        "READ",
        "LOW",
      ],
      [
        "Read policy compliance states",
        "Microsoft.PolicyInsights/policyStates/read",
        "READ",
        "LOW",
      ],
      ...
      [
        "Read Compliance Manager assessments",
        "Microsoft.ComplianceManagement/assessments/read",
        "READ",
        "LOW",
      ],
      [
        "Read Management Group",
        "Microsoft.Management/managementGroups/read",
        "READ",
        "LOW",
      ],
      [
        ...
        "Microsoft.ComplianceManagement/assessments/write",
        "WRITE",
        "MEDIUM",
      ],
      [
  ...
  },
  {
    ...
    title: "Workload Protection (CWPP)",
    subtitle:
      "Defender for Servers, VM vulnerability assessments, JIT access, App Service, AKS workloads",
    ops: mkOps(5, [
      [
        "Read Defender for Servers plan",
      ...
      [
        "Read VM vulnerability assessments",
  ...
  },
  {
    ...
    title: "Containers & Kubernetes (KSPM)",
    subtitle:
      "AKS cluster posture, ACR image vulnerabilities, container instance groups",
    ops: mkOps(6, [
      [
        "Read AKS clusters",
        "Microsoft.ContainerService/managedClusters/read",
      ...
      [
        "Read AKS agent pools",
        "Microsoft.ContainerService/managedClusters/agentPools/read",
        "READ",
        "LOW",
      ],
      [
        "Read AKS diagnostics",
        "Microsoft.ContainerService/managedClusters/diagnosticsSettings/read",
        "READ",
        "LOW",
      ],
      [
      ...
      [
        "Read Defender for Containers plan",
        "Microsoft.Security/pricings/read",
        "READ",
        "LOW",
      ],
      [
        "Read container image vulnerabilities",
        "Microsoft.Security/serverVulnerabilityAssessments/read",
        "READ",
        "LOW",
      ],
      [
        "Read container instance groups",
      ...
      [
        "Run ACR image scan",
        "Microsoft.ContainerRegistry/registries/buildTask/write",
        "WRITE",
        "MEDIUM",
      ],
      [
  ...
  },
  {
    ...
    title: "Network Security",
    subtitle:
      "VNets, NSGs, Azure Firewall, WAF, DDoS, ExpressRoute, Private Endpoints, Network Watcher",
    ops: mkOps(7, [
      ...
      [
        "Read NSG flow logs",
        "Microsoft.Network/networkSecurityGroups/flowLogs/read",
        "READ",
        "LOW",
      ],
      [
      ...
      [
        "Read Azure WAF policy",
        "Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/read",
        "READ",
        "LOW",
      ],
      [
        "Read DDoS protection plans",
      ...
      [
        "Read Private Endpoints",
        "Microsoft.Network/privateEndpoints/read",
        "READ",
        "LOW",
      ],
      [
        "Read network watchers",
      ...
      [
        ...
        "Microsoft.Network/networkSecurityGroups/flowLogs/write",
        "WRITE",
        "MEDIUM",
      ],
      [
  ...
  },
  {
    ...
    title: "Threat Detection (CDR)",
    subtitle:
      "Defender XDR alerts, Sentinel incidents/rules, threat intelligence, threat hunting queries",
    ops: mkOps(8, [
      ...
      [
        "Read threat intelligence indicators",
  ...
  },
  {
    ...
    title: "IaC & DevSecOps",
    subtitle:
      "ARM deployments, Defender for DevOps, Azure DevOps pipelines, GitHub Advanced Security",
    ops: mkOps(9, [
      [
        "Read ARM deployments",
        "Microsoft.Resources/deployments/read",
        "READ",
        "LOW",
      ],
      [
        "Read ARM deployment operations",
        "Microsoft.Resources/deployments/operations/read",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for DevOps results",
        "Microsoft.Security/devops/read",
        "READ",
        "LOW",
      ],
      ["Read Azure DevOps pipelines", "ADO PAT: vso.build", "READ", "LOW"],
      [
        "Read GitHub Advanced Security alerts",
        "GitHub App: security_events",
        "READ",
        "LOW",
      ],
      [
        "Read Bicep/ARM templates (Resource Graph)",
        "Microsoft.ResourceGraph/resources/read",
        "READ",
        "LOW",
      ],
      [
        "Create/update ARM deployment",
  ...
  },
  {
    ...
    title: "Supply Chain & SBOM",
    subtitle:
      "ACR image manifests, GitHub Advanced Security supply chain, Defender for DevOps SBOM, Content Trust",
    ops: mkOps(10, [
      [
        "Read ACR image manifests",
        "Microsoft.ContainerRegistry/registries/pull/read",
        "READ",
        "LOW",
      ],
      [
        "Read GitHub Advanced Security supply chain alerts",
        "GitHub App: security_events",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for DevOps SBOM report",
        "Microsoft.Security/devops/read",
        "READ",
        "LOW",
      ],
      [
        "Read Microsoft SBOM Tool output",
        "Microsoft.Security/serverVulnerabilityAssessments/read",
        "READ",
        "LOW",
      ],
      [
        "Read ACR Content Trust (notary)",
        "Microsoft.ContainerRegistry/registries/read",
        "READ",
        "LOW",
      ],
  ...
  },
  {
    ...
    title: "Secrets Detection",
    subtitle:
      "Key Vault secrets/keys/certs metadata, GitHub secret alerts, Defender for DevOps, Entra app secrets",
    ops: mkOps(11, [
      [
        "Read Key Vault secrets metadata",
        "Microsoft.KeyVault/vaults/secrets/read",
      ...
      [
        "Read Key Vault certificates metadata",
        "Microsoft.KeyVault/vaults/certificates/read",
        "READ",
        "LOW",
      ],
      [
        "Read Key Vault vault metadata",
        "Microsoft.KeyVault/vaults/read",
        "READ",
        "LOW",
      ],
      [
        "Read GitHub Advanced Security secret alerts",
        "GitHub App: security_events",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for DevOps secret scanning",
        "Microsoft.Security/devops/read",
        "READ",
        "LOW",
      ],
      [
        "Read Entra app client secrets metadata",
        "Application.Read.All",
        "READ",
        "LOW",
      ],
      [
        "Read Managed Identity credentials",
        "Microsoft.ManagedIdentity/userAssignedIdentities/read",
        "READ",
        "LOW",
      ],
  ...
  },
  {
    ...
    title: "API Security",
    subtitle:
      "API Management services, Defender for APIs, Azure API Center, WAF policies for APIM",
    ops: mkOps(12, [
      [
        "Read API Management services",
      ...
      [
        "Read APIM API operations",
        "Microsoft.ApiManagement/service/apis/operations/read",
        "READ",
        "LOW",
      ],
      [
        "Read APIM subscriptions",
        "Microsoft.ApiManagement/service/subscriptions/read",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for APIs findings",
        "Microsoft.Security/apiCollections/read",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for APIs alerts",
        "Microsoft.Security/alerts/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure API Center APIs",
        "Microsoft.ApiCenter/services/apis/read",
        "READ",
        "LOW",
      ],
      [
        "Read WAF policies (APIM)",
        "Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/read",
        "READ",
        "LOW",
      ],
  ...
  },
  {
    ...
    title: "Data Security (DSPM)",
    subtitle:
      "Storage accounts, SQL TDE, CosmosDB, Purview data catalog, Defender for Databases, Key Vault",
    ops: mkOps(13, [
      [
        "Read storage accounts",
        "Microsoft.Storage/storageAccounts/read",
      ...
      [
        "Read storage account keys metadata",
        "Microsoft.Storage/storageAccounts/listKeys/action",
        "READ",
        "MEDIUM",
      ],
      [
        "Read Blob service properties",
        "Microsoft.Storage/storageAccounts/blobServices/read",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for Storage alerts",
        "Microsoft.Security/alerts/read",
        "READ",
        "LOW",
      ],
      ...
      [
        "Read Azure SQL databases",
        "Microsoft.Sql/servers/databases/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure SQL TDE status",
        "Microsoft.Sql/servers/databases/transparentDataEncryption/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure SQL audit policies",
        "Microsoft.Sql/servers/auditingSettings/read",
        "READ",
        "LOW",
      ],
      [
        "Read CosmosDB accounts",
        "Microsoft.DocumentDB/databaseAccounts/read",
        "READ",
        "LOW",
      ],
      [
        "Read Purview data catalog",
        "Microsoft.Purview/accounts/read",
        "READ",
        "LOW",
      ],
      [
        "Read Purview scan results",
        "Microsoft.Purview/accounts/readScanResult/action",
        "READ",
        "LOW",
      ],
      [
      ...
      [
        "Read Defender for Databases plan",
        "Microsoft.Security/pricings/read",
        "READ",
        "LOW",
      ],
      ...
      [
        ...
        "Microsoft.Purview/accounts/runScan/action",
        "WRITE",
        "MEDIUM",
      ],
    ]),
  },
  {
    ...
    title: "SaaS Security (SSPM)",
    subtitle:
      "M365 Secure Score, Entra apps, SharePoint, Teams, Exchange, Conditional Access, MCAS discovered apps",
    ops: mkOps(14, [
      ["Read M365 Secure Score", "SecurityEvents.Read.All", "READ", "LOW"],
      ["Read all users (M365)", "User.Read.All", "READ", "LOW"],
      ["Read all groups", "Group.Read.All", "READ", "LOW"],
      [
        "Read OAuth2 permission grants (consent)",
        "DelegatedPermissionGrant.Read.All",
        "READ",
        "LOW",
      ],
      ...
      [
        "Read auth methods policy",
        "Policy.Read.AuthenticationMethod",
        "READ",
        "LOW",
      ],
      [
        "Read Defender for Cloud Apps alerts",
        "MCAS API token (Bearer)",
        "READ",
        "LOW",
      ],
      [
        "Read MCAS SaaS app activity",
        "MCAS API: activities/ endpoint",
        "READ",
        "LOW",
      ],
      [
        "Read MCAS SaaS discovered apps",
        "MCAS API: discovery/ endpoint",
        "READ",
        "LOW",
      ],
      [
  ...
  },
  {
    ...
    title: "AI Security Posture (AI-SPM)",
    subtitle:
      "Defender AI SPM, Azure AI Foundry, Azure ML models/endpoints, Azure OpenAI, AI Content Safety",
    ops: mkOps(15, [
      [
        "Read Defender AI Security Posture",
        "Microsoft.Security/pricings/read",
        "READ",
        "LOW",
      ],
      [
        "Read AI workload assessments",
        "Microsoft.Security/assessments/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure AI Foundry projects",
        "Microsoft.MachineLearningServices/workspaces/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure ML models",
        "Microsoft.MachineLearningServices/workspaces/models/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure ML endpoints",
        "Microsoft.MachineLearningServices/workspaces/onlineEndpoints/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure ML datasets",
        "Microsoft.MachineLearningServices/workspaces/datasets/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure OpenAI accounts",
        "Microsoft.CognitiveServices/accounts/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure OpenAI deployments",
        "Microsoft.CognitiveServices/accounts/deployments/read",
        "READ",
        "LOW",
      ],
      [
        "Read Azure AI Content Safety",
        "Microsoft.CognitiveServices/accounts/read",
        "READ",
        "LOW",
      ],
      [
        "Read Copilot for Security incidents",
        "SecurityIncident.Read.All",
        "READ",
        "LOW",
      ],
      [
        "Read AI workload vulnerabilities",
        "Microsoft.Security/serverVulnerabilityAssessments/read",
        "READ",
        "LOW",
      ],
      [
        "Enable Defender AI SPM",
        "Microsoft.Security/pricings/write",
        "WRITE",
        "HIGH",
      ],
      [
        "Update Azure OpenAI model filters",
        "Microsoft.CognitiveServices/accounts/write",
        "WRITE",
        "HIGH",
      ],
      [
        "Delete ML model deployment",
        "Microsoft.MachineLearningServices/workspaces/onlineEndpoints/delete",
        "WRITE",
        "HIGH",
      ],
      [
        "Update Azure AI Content Safety policies",
        "Microsoft.CognitiveServices/accounts/write",
        "WRITE",
        "HIGH",
      ],
...
const GCP_LAYERS: CnappLayer[] = [
  {
    ...
    title: "Identity & Access (CIEM)",
    subtitle:
      "Service accounts, IAM policies, organization roles, workload identity, Workspace users",
    ops: mkOps(1, [
      ...
      [
        "Admin SDK: List users (Workspace)",
        "admin.directory.user.readonly",
        "READ",
        "LOW",
      ],
      [
        "Admin SDK: List groups",
        "admin.directory.group.readonly",
        "READ",
        "LOW",
      ],
      [
        "Set IAM policy (project)",
  ...
  },
  {
    ...
    title: "Non-Human Identity (NHI)",
    subtitle:
      "Service account keys, workload identity pools, Secret Manager, Cloud Functions, Vertex AI agents",
    ops: mkOps(2, [
      ["List service accounts", "iam.serviceAccounts.list", "READ", "LOW"],
  ...
  },
  {
    ...
    title: "Posture & Config (CSPM)",
    subtitle:
      "SCC findings, asset inventory, org policies, compute, storage, KMS, logging sinks",
    ops: mkOps(3, [
      ...
      [
        "Search all resources (Asset Inv.)",
  ...
  },
  {
    ...
    title: "Compliance & Governance",
    subtitle:
      "SCC compliance findings, Assured Workloads, org policy constraints, audit log entries",
    ops: mkOps(4, [
      [
        "List SCC compliance findings",
        "securitycenter.findings.list",
        "READ",
        "LOW",
      ],
      [
        "Get Assured Workloads workload",
      ...
      [
        ...
        "assuredworkloads.workloads.list",
        "READ",
        "LOW",
      ],
      [
      ...
      [
        ...
        "assuredworkloads.workloads.create",
        "WRITE",
        "HIGH",
      ],
  ...
  },
  {
    ...
    title: "Workload Protection (CWPP)",
    subtitle:
      "Compute instances, Cloud Functions, Cloud Run, OS Config/VM Manager, SCC vulnerability findings",
    ops: mkOps(5, [
      ["List compute instances", "compute.instances.list", "READ", "LOW"],
      ["Get compute instance", "compute.instances.get", "READ", "LOW"],
      [
        "List compute machine images",
      ...
      ["Get Cloud Run service", "run.services.get", "READ", "LOW"],
      [
        "List SCC vulnerability findings",
        "securitycenter.findings.list",
        "READ",
        "LOW",
      ],
      [
        "List OS inventory (VM Manager)",
        "osconfig.inventories.list",
        "READ",
        "LOW",
      ],
      [
        "Get OS patch deployment",
        "osconfig.patchDeployments.get",
        "READ",
        "LOW",
      ],
      [
        "Get OS vulnerability report",
  ...
  },
  {
    ...
    title: "Containers & Kubernetes (KSPM)",
    subtitle:
      "GKE clusters, node pools, Artifact Registry, Binary Authorization, container vulnerability reports",
    ops: mkOps(6, [
      ...
      [
        "Get GKE cluster security posture",
      ...
      [
        "Get Artifact Registry repo IAM policy",
        "artifactregistry.repositories.getIamPolicy",
        "READ",
        "LOW",
      ],
      [
        "List container vulnerability reports",
        "ondemandscanning.operations.list",
        "READ",
        "LOW",
      ],
      [
        "Get Artifact Analysis occurrence",
      ...
      [
        "Delete Artifact Registry package",
  ...
  },
  {
    ...
    title: "Network Security",
    subtitle:
      "VPC firewall rules, Cloud Armor, DNS, VPC Flow Logs, Cloud NAT, load balancers, hierarchical policies",
    ops: mkOps(7, [
  ...
  },
  {
    ...
    title: "Threat Detection (CDR)",
    subtitle:
      "SCC threat findings, Event Threat Detection, Cloud IDS, audit logs, DNS logs, SIEM export",
    ops: mkOps(8, [
      ["List SCC findings", "securitycenter.findings.list", "READ", "LOW"],
      ["Get SCC finding", "securitycenter.findings.get", "READ", "LOW"],
      [
        "List Event Threat Detection sources",
  ...
  },
  {
    ...
    title: "IaC & DevSecOps",
    subtitle:
      "Cloud Deployment Manager, Cloud Build triggers, Cloud Deploy pipelines, Config Connector",
    ops: mkOps(9, [
      [
  ...
  },
  {
    ...
    title: "Supply Chain & SBOM",
    subtitle:
      "Artifact Analysis, Artifact Registry, Binary Authorization, SLSA provenance, Software Delivery Shield",
    ops: mkOps(10, [
      [
        "List Artifact Analysis occurrences",
        "containeranalysis.occurrences.list",
        "READ",
        "LOW",
      ],
      ...
      [
        "Get Software Delivery Shield insights",
      ...
      [
        "Get Binary Authorization attestors",
        "binaryauthorization.attestors.list",
        "READ",
        "LOW",
      ],
      [
        "Get SLSA provenance attestation",
        "containeranalysis.occurrences.get",
        "READ",
        "LOW",
      ],
  ...
  },
  {
    ...
    title: "Secrets Detection",
    subtitle:
      "Secret Manager metadata, DLP inspect jobs and findings, Artifact Analysis secret occurrences",
    ops: mkOps(11, [
      [
        "List Secret Manager secrets",
        "secretmanager.secrets.list",
      ...
      [
        "Get Secret Manager secret (metadata)",
        "secretmanager.secrets.get",
        "READ",
        "LOW",
      ],
      [
        "List secret versions (metadata)",
      ...
      [
        "Get SCC leaked credential findings",
        "securitycenter.findings.list",
        "READ",
        "LOW",
      ],
      [
        "Scan for secrets (Cloud DLP)",
      ...
      [
        "List Artifact Analysis secret occurrences",
        "containeranalysis.occurrences.list",
        "READ",
        "LOW",
      ],
  ...
  },
  {
    ...
    title: "API Security",
    subtitle:
      "Apigee organizations, proxies, analytics, Cloud Endpoints, Cloud Armor L7 policies",
    ops: mkOps(12, [
      ...
      [
        "List Cloud Endpoints services",
        "servicemanagement.services.list",
        "READ",
        "LOW",
      ],
      [
        "Get Cloud Endpoint rollout",
        "servicemanagement.services.get",
        "READ",
        "LOW",
      ],
      [
        "Get Cloud Armor security policy",
  ...
  },
  {
    ...
    title: "Data Security (DSPM)",
    subtitle:
      "Cloud Storage, Cloud SQL, BigQuery, Spanner, Bigtable, DLP classification, KMS encryption",
    ops: mkOps(13, [
      ...
      [
        "Get BigQuery dataset IAM policy",
  ...
  },
  {
    ...
    title: "SaaS Security (SSPM)",
    subtitle:
      "Google Workspace users, groups, OAuth tokens, third-party apps, Cloud Identity groups",
    ops: mkOps(14, [
      ...
      [
        "Read Workspace domain settings",
        "admin.directory.domain.readonly",
        "READ",
        "LOW",
      ],
      [
        "Read Workspace OAuth tokens",
        "admin.directory.tokens.readonly",
        "READ",
        "LOW",
      ],
      [
        "Read Workspace third-party app access",
        "admin.directory.userschema.readonly",
        "READ",
        "LOW",
      ],
      [
        "Read Workspace Security Center reports",
        "admin.reports.audit.readonly",
        "READ",
        "LOW",
      ],
      [
        "Read Workspace login activity",
        "admin.reports.usage.readonly",
        "READ",
        "LOW",
      ],
      [
        "List GCP Cloud Identity groups",
        "cloudidentity.groups.list",
        "READ",
        "LOW",
      ],
      [
        "List Workspace Marketplace apps",
        "Admin SDK marketplace",
        "READ",
        "LOW",
      ],
      [
        "Revoke Workspace OAuth token",
        "admin.directory.tokens.delete",
        "WRITE",
        "HIGH",
      ],
      [
        "Suspend Workspace user",
        "admin.directory.user.update",
        "WRITE",
        "HIGH",
      ],
      [
        "Remove third-party app access",
        "admin.directory.userschema.delete",
        "WRITE",
        "HIGH",
      ],
    ]),
  },
  {
    ...
    title: "AI Security Posture (AI-SPM)",
    subtitle:
      "Vertex AI models, endpoints, datasets, training jobs, Model Armor templates, DLP on training data",
    ops: mkOps(15, [
      ["List Vertex AI models", "aiplatform.models.list", "READ", "LOW"],
      ...
      [
        "List Vertex AI feature stores",
        "aiplatform.featurestores.list",
        "READ",
        "LOW",
      ],
      [
        "List Vertex AI Agent Engine deployments",
      ...
      [
        "Undeploy Vertex AI model",
        "aiplatform.endpoints.undeploy",
        "WRITE",
        "HIGH",
      ],
      [
        "Stop Vertex AI training pipeline",
...
const CONNECTORS: Connector[] = [
  {
    ...
    status: "connected",
    description:
      "Cross-account read access to your AWS production environment. CloudGuard uses an IAM role with least-privilege inline policies per CNAPP layer to enumerate resources, stream CloudTrail events, and optionally remediate findings.",
    cnappLayers: AWS_LAYERS,
    credential: {
      type: "IAM Role",
      label: "Cross-account IAM Role",
      fields: [
        {
          label: "Role ARN",
          value: "arn:aws:iam::123456789012:role/CloudGuardAuditRole",
          masked: false,
        },
        {
          label: "External ID",
  ...
  },
  {
    ...
    status: "connected",
    description:
      "Service principal with Reader + Security Reader roles scoped to your EU subscriptions. CloudGuard uses Microsoft Graph, ARM, and Defender for Cloud APIs across all 15 CNAPP layers.",
  ...
  },
  {
    ...
    status: "connected",
    description:
      "Workload Identity federation with a service account bound to Security Reviewer and Viewer roles at organization level. CloudGuard uses Cloud Asset Inventory and Security Command Center APIs across all 15 CNAPP layers.",
    cnappLayers: GCP_LAYERS,
    credential: {
      type: "Workload Identity",
      label: "GCP Service Account (WIF)",
      fields: [
        { label: "Project ID", value: "my-company-dev-482910", masked: false },
        {
          label: "Service Account",
          value:
            "cloudguard-audit@my-company-dev-482910.iam.gserviceaccount.com",
          masked: false,
        },
        {
          label: "WIF Pool",
          value:
            "projects/482910/locations/global/workloadIdentityPools/cg-pool",
          masked: false,
        },
      ],
    },
    accounts: [
      {
        id: "my-company-dev-482910",
        label: "Dev Project",
        region: "us-central1",
        status: "active",
      },
      {
        id: "my-company-sandbox-183746",
  ...
  return (
    <span
      style={{
        fontSize: 9,
        fontWeight: 600,
        color: opType === "READ" ? S.accent : S.warning,
        fontFamily: "monospace",
        letterSpacing: "0.04em",
      }}
    >
        ...
        return (
          ...
          >
            {s === "allow" && (
              <CheckCircle2
                size={12}
                color={active ? S.success : S.textMuted}
              />
            )}
            {s === "ask" && (
              <Eye size={12} color={active ? S.warning : S.textMuted} />
            )}
            {s === "never" && (
              <Ban size={12} color={active ? S.danger : S.textMuted} />
            )}
          </button>
        );
      })}
    ...
    >
      <button
        ...
        style={{
          ...
          gap: 10,
          padding: "10px 14px",
          background: open ? "var(--cg-bg-card)" : "transparent",
          border: "none",
          cursor: "pointer",
          textAlign: "left",
        ...
        <div>
          ...
          <div style={{ borderTop: `1px solid ${S.border}` }}>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "2fr 2fr 62px 56px 90px",
                padding: "7px 14px",
                borderBottom: `1px solid ${S.border}`,
                background: "var(--cg-bg-page)",
              }}
            >
              {["Operation", "Permission String", "Type", "Risk", "Allow"].map(
                (h) => (
                  <span
                    key={h}
                    style={{
...
function defaultPerms(): Record<string, PermState> {
  ...
  for (const c of CONNECTORS) {
    ...
    if (c.permGroups) {
      for (const g of c.permGroups)
        for (const p of g.permissions) init[`${c.id}::${p.key}`] = p.state;
    }
  }
  return init;
}
...
export default function ConnectorsSettings() {
  ...
  const [perms, setPerms] = React.useState<Record<string, PermState>>(() => {
    const init = defaultPerms();
    try {
      const raw = localStorage.getItem(LS_PERMS);
      if (raw)
        return { ...init, ...(JSON.parse(raw) as Record<string, PermState>) };
    } catch {
      /* ignore */
    }
    return init;
  ...
  const { dirty, baseline, reset } = useDirty(perms);
  const toast = useUndoToast();

  const connector = CONNECTORS.find((c) => c.id === selected)!;
  const setPerm = (key: string, state: PermState) =>
  ...
  // Apply a least-privilege / read-only / full preset to the current connector's keys.
  const applyPreset = (preset: "readonly" | "leastpriv" | "full") => {
    setPerms((p) => {
      const next = { ...p };
      for (const k of Object.keys(next)) {
        if (!k.startsWith(`${connector.id}::`)) continue;
        const isWrite =
          /(:write|:Rotate|:Put|:Create|:Delete|:Update|secrets\/write)/i.test(
            k,
          );
        next[k] =
          preset === "full"
    ...
    <div style={{ display: "flex", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        >
          <button
            type="button"
            onClick={() =>
              toast.show("Connect a cloud — AWS / Azure / GCP onboarding")
            }
            style={{
              width: "100%",
              height: 34,
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "32px 40px" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            >
              <CloudIcon
                ...
                size={28}
                uid={`hdr-${connector.id}`}
              />
            </div>
            <div>
              <div
                style={{ fontSize: 18, fontWeight: 500, color: S.textPrimary }}
              >
                {connector.name}
              </div>
              <div
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <ConfirmButton
              ...
              body="CloudGuard will stop scanning this account and lose access until you reconnect. Findings already collected are retained."
              confirmLabel="Disconnect"
              onConfirm={() =>
                toast.show(`${connector.name} disconnected`, () => {})
              }
            />
            <button
              type="button"
              onClick={() => toast.show("Connector menu — coming soon")}
              style={{
                height: 32,
                width: 32,
                borderRadius: 6,
        ...
        >
          ...
          {[
            { k: "readonly" as const, label: "Read-only audit" },
            { k: "leastpriv" as const, label: "Least privilege" },
            { k: "full" as const, label: "Full CNAPP" },
          ].map((p) => (
            <button
              key={p.k}
              type="button"
        ...
        {connector.cnappLayers && (
          <div style={{ marginBottom: 28 }}>
            ...
            >
              ...
              >
                Permissions — All 15 CNAPP Layers
              </h2>
              <div style={{ display: "flex", gap: 12 }}>
                {[
                  {
                    icon: <CheckCircle2 size={11} color={S.success} />,
                    label: "Always allow",
                  },
                  {
                    icon: <Eye size={11} color={S.warning} />,
                    label: "Ask each time",
                  },
        ...
        {connector.permGroups &&
          connector.permGroups.map((group) => (
          ...
          >
            ...
            >
              <div>
                ...
                <span
                  style={{ fontSize: 11, color: S.textMuted, marginLeft: 8 }}
                >
                  {connector.credential.type}
                </span>
              </div>
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                <button
                  type="button"
                  onClick={() =>
                    toast.show(`${connector.credential.label} rotated`)
                  }
                  style={{
                    height: 26,
                    padding: "0 10px",
                ...
                <ConfirmButton
                  ...
                  body="CloudGuard will immediately lose access to this connector until new credentials are added."
                  confirmLabel="Remove credentials"
                  onConfirm={() => toast.show("Credentials removed")}
                  style={{ fontSize: 11 }}
                />
              </div>
            </div>
              ...
              {connector.credential.fields.map((f) => (
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 12,
                      color: f.masked ? S.textMuted : S.textSecondary,
                      fontFamily: "monospace",
                      wordBreak: "break-all",
                    }}
                  >
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  ...
                  <span
                    style={{
                      fontSize: 12,
                      color: a.status === "active" ? S.success : S.textMuted,
                      textTransform: "capitalize",
                    }}
                  >
                    {a.status}
