                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      // Same raised grey the drawer's selected controls use, so
                      // "chosen" looks the same everywhere in the app.
                      background: on ? "var(--cg-selected-bg)" : "transparent",
                      color: on ? "var(--cg-selected-text)" : T.textNav,
                      fontSize: 12,
                      cursor: "pointer",
                    }}
                  >
