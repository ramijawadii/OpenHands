...
function DataTableLayout({
  ...
  return (
    <div
      /* LOCAL EDIT (CloudGuard): no `min-w-80`. In a chat column that floor
         forced a horizontal scrollbar on narrow drawers instead of letting the
         table reflow into its card layout. */
