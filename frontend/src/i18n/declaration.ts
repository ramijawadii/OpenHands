...
export enum I18nKey {
  ...
  BITBUCKET$WEBHOOK_SECTION_TITLE = "BITBUCKET$WEBHOOK_SECTION_TITLE",
  BITBUCKET$NOT_CONNECTED = "BITBUCKET$NOT_CONNECTED",
  BITBUCKET$WEBHOOK_MANAGER_TITLE = "BITBUCKET$WEBHOOK_MANAGER_TITLE",
  BITBUCKET$WEBHOOK_MANAGER_LOADING = "BITBUCKET$WEBHOOK_MANAGER_LOADING",
  BITBUCKET$WEBHOOK_MANAGER_ERROR = "BITBUCKET$WEBHOOK_MANAGER_ERROR",
  BITBUCKET$WEBHOOK_MANAGER_NO_RESOURCES = "BITBUCKET$WEBHOOK_MANAGER_NO_RESOURCES",
  BITBUCKET$WEBHOOK_MANAGER_DESCRIPTION = "BITBUCKET$WEBHOOK_MANAGER_DESCRIPTION",
  BITBUCKET$WEBHOOK_STATUS_INSTALLED = "BITBUCKET$WEBHOOK_STATUS_INSTALLED",
  BITBUCKET$WEBHOOK_STATUS_NOT_INSTALLED = "BITBUCKET$WEBHOOK_STATUS_NOT_INSTALLED",
  BITBUCKET$WEBHOOK_COLUMN_REPOSITORY = "BITBUCKET$WEBHOOK_COLUMN_REPOSITORY",
  BITBUCKET$WEBHOOK_COLUMN_STATUS = "BITBUCKET$WEBHOOK_COLUMN_STATUS",
  BITBUCKET$WEBHOOK_COLUMN_ACTION = "BITBUCKET$WEBHOOK_COLUMN_ACTION",
  BITBUCKET$WEBHOOK_INSTALLED_BY = "BITBUCKET$WEBHOOK_INSTALLED_BY",
  BITBUCKET$WEBHOOK_INSTALL = "BITBUCKET$WEBHOOK_INSTALL",
  BITBUCKET$WEBHOOK_REINSTALL = "BITBUCKET$WEBHOOK_REINSTALL",
  BITBUCKET$WEBHOOK_INSTALLING = "BITBUCKET$WEBHOOK_INSTALLING",
  BITBUCKET$WEBHOOK_UNINSTALL = "BITBUCKET$WEBHOOK_UNINSTALL",
  BITBUCKET$WEBHOOK_UNINSTALLING = "BITBUCKET$WEBHOOK_UNINSTALLING",
  BITBUCKET$WEBHOOK_INSTALL_SUCCESS = "BITBUCKET$WEBHOOK_INSTALL_SUCCESS",
  BITBUCKET$WEBHOOK_INSTALL_FAILED = "BITBUCKET$WEBHOOK_INSTALL_FAILED",
  BITBUCKET$WEBHOOK_UNINSTALL_SUCCESS = "BITBUCKET$WEBHOOK_UNINSTALL_SUCCESS",
  BITBUCKET$WEBHOOK_UNINSTALL_FAILED = "BITBUCKET$WEBHOOK_UNINSTALL_FAILED",
