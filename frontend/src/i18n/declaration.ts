...
export enum I18nKey {
  ...
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_LABEL = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_LABEL",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_HINT = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_HINT",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_SAVED = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_SAVED",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_PLACEHOLDER = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_PLACEHOLDER",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_INVALID = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_INVALID",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_CMD_MACOS = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_CMD_MACOS",
  SETTINGS$AGENT_CLAUDE_CREDENTIALS_CMD_LINUX = "SETTINGS$AGENT_CLAUDE_CREDENTIALS_CMD_LINUX",
  SETTINGS$AGENT_CODEX_CREDENTIALS_LABEL = "SETTINGS$AGENT_CODEX_CREDENTIALS_LABEL",
  SETTINGS$AGENT_CODEX_CREDENTIALS_HINT = "SETTINGS$AGENT_CODEX_CREDENTIALS_HINT",
  SETTINGS$AGENT_CODEX_CREDENTIALS_SAVED = "SETTINGS$AGENT_CODEX_CREDENTIALS_SAVED",
  SETTINGS$AGENT_CODEX_CREDENTIALS_PLACEHOLDER = "SETTINGS$AGENT_CODEX_CREDENTIALS_PLACEHOLDER",
  SETTINGS$AGENT_CODEX_CREDENTIALS_INVALID = "SETTINGS$AGENT_CODEX_CREDENTIALS_INVALID",
  SETTINGS$AGENT_CODEX_CREDENTIALS_CMD = "SETTINGS$AGENT_CODEX_CREDENTIALS_CMD",
  SETTINGS$AGENT_AUTH_SUBSCRIPTION_TITLE = "SETTINGS$AGENT_AUTH_SUBSCRIPTION_TITLE",
  SETTINGS$AGENT_AUTH_SECRET_DETECTED = "SETTINGS$AGENT_AUTH_SECRET_DETECTED",
  SETTINGS$AGENT_AUTH_SECRET_NOT_DETECTED = "SETTINGS$AGENT_AUTH_SECRET_NOT_DETECTED",
  SETTINGS$AGENT_CLAUDE_AUTH_INSTRUCTIONS = "SETTINGS$AGENT_CLAUDE_AUTH_INSTRUCTIONS",
  SETTINGS$AGENT_CODEX_AUTH_INSTRUCTIONS = "SETTINGS$AGENT_CODEX_AUTH_INSTRUCTIONS",
